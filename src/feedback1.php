...
<body>
  ...
  <div class="feedback-wrapper at-bottom">
    <div class="feedback-title">
      <h1 class="text-center">How would you rate your ride?
      </h1>
    </div>
      ...
      <div class="feedback-faces">
        <div class="row">
          <div class="face-wrapper slide-out-y-alt">
            <div class="face-counter invisible" data-title-none="No one rated it like this"
              data-title-one="One person rated it like this" data-title-many="other people rated it like this"></div>
  ...
  <div align="center"><br>
    <button onclick="location.href='http://localhost/shuttle/feedback2.php'" type="button" class="btn btn-primary"
      value="back">Next</button>
  </div>
  <script>
    const $canvas = $('body');
    const $eyes = $('.eye');
